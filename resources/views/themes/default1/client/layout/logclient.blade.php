                    ...
                    <div class="form-border" style="z-index: 0;width: 85%;">
                        <div class="form-inline ">
                            <div class="form-group input-group " style="width: 98% ">
                                <input type="text" name="s" class="search-field form-control" title="Enter search term" placeholder="ada yang ingin ditanyakan? ketikkan kata kunci disini..." required="" style="width: 80%">
