...
{
    /**
     * Instance of PhpMailController.
     *
     * @var PhpMailController
     */
    ...
    public function update($id, User $user, AgentUpdate $request, Assign_team_agent $team_assign_agent)
    {
        ...
        try {
            ...
            return redirect('agents')->with('fails', Lang::get('lang.unable_to_update_agent').($e->getMessage() ? '<li>'.$e->getMessage().'</li>' : ''));
        }
    }
